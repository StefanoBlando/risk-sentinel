...
- Stability: 40 to 55
- Clarity and Similarity Enhancement: 75 to 90
- Style Exaggeration: 5 to 15
- Speaker Boost: on
- Pace: slightly slower than default

### Descript

- Choose a neutral corporate voice
- Set pacing to medium-slow
- Add pauses manually after key claims
- Avoid over-energetic delivery

### Adobe Express

- Voice: neutral or documentary style
- Speed: 0.92x to 0.97x
- Pitch: default
- Emphasis: only on product name and closing line
